...
/**
 * The controller for the list users http console page. This controller uses exact path matching not prefix matching
 ...
 */
public class ListUsersController extends RestHandlerBase {

    private final Configuration fmCfg;

    public ListUsersController(String path, Configuration fmCfg) {
    ...
    public void doHandle(String target, Request baseRequest, HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        Template t = fmCfg.getTemplate(Service.UI_TEMPLATES_PATH + "/listUsers.ftl");
        ...
        root.put("page", "list-users"); // tells tabs fragment which tab is active
